...
%
To that end, we define an inference prior through mixing the two monitoring priors.
%, with the optional addition of a locally non-informative prior to provide added robustness.
{
...
%\end{equation}
%where $\omega_S+\omega_E$ and each weight is non-negative. 
	%
One may take a fixed value of $\omega_S=\omega_E=1/2$ in \eqref{eq:inference_prior} to obtain an \textit{agnostic} inference prior since it 
...
\centering
\caption{Interim sample size at stoppage for efficacy by choice of minimum skeptical mixture weight $\delta$ and upwards scaling of Bayesian $p$-value of $0.5$ ($\beta$) using concentrated skeptical prior and default enthusiastic prior.}%
\begin{tabular*}{300pt}{@{\extracolsep\fill}cccccc@{\extracolsep\fill}}%
\toprule
\textbf{$\delta$ / $\beta$} & 0.5	&	0.6	&	0.7	&	0.8	&	0.9\\
\midrule
0.00	&	62	&	54	&	54	&	50	&	50	\\
0.05	&	62	&	62	&	54	&	54	&	54	\\
0.10	&	72	&	62	&	62	&	54	&	54	\\

...
\begin{figure}
\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure1a.png}
\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure1b.png}

\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure1c.png}
\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure1d.png}
...
\begin{figure}
\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure5a.png}
\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure5b.png}

\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure5c.png}

\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure5d.png}
\includegraphics[width=3in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure5e.png}
...
\begin{figure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure2a.png}
    \caption{An example path - early stopage for efficacy.}
	\label{fig:figure2a}
  \end{subfigure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure2b.png}
...
\begin{figure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure3a.png}
    \caption{Caption text 1}
  \end{subfigure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure3b.png}
...
\begin{figure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure4.png}
    \caption{Caption text 1}
  \end{subfigure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figureS1.png}
    \caption{Caption text 2}
  \end{subfigure}
...
\begin{figure}
    \centering\includegraphics[width=3.5in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure6.png}
    \caption{Caption text 2}
 \end{figure}
...
\begin{figure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figureS2a.png}
    \caption{Caption text 1}
  \end{subfigure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figureS2b.png}
    \caption{Caption text 2}
  \end{subfigure}
 \end{figure}
\begin{figure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figureS2c.png}
    \caption{Caption text 1}
  \end{subfigure}
  \begin{subfigure}{7in}
    \centering\includegraphics[width=7in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figureS2d.png}
    \caption{Caption text 2}
  \end{subfigure}
\end{figure}

...
\begin{center}
\includegraphics[width=5in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure3b.png}
...
%\end{itemize}
\begin{center}
\includegraphics[width=7.5in]{P:/Git/Bayesian-Sequential-Monitoring/00-paper/FIGURES/figure4.png}

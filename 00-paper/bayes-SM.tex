...
\begin{center}
\includegraphics[width=6in]{D:/Users/ekwiatko/Documents/GitHub/Bayesian-Sequential-Monitoring/00-paper/FIGURES/4priors.png}

Figure 1: (a) Default skeptical prior ($\beta=2)$ (b) Default enthuastic prior ($\beta=2)$ \\(c) Concentrated skeptical prior (d) Flattened enthaustic prior
\end{center}
